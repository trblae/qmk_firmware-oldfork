...
[LOWER_LAYER] = KEYMAP( \
  ...
  M(M_TENKEY_LAYER), KC_HYPR, _______, KC_LALT, _______, _______, /**/ _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END \
),
...
[SPACEFN_LAYER] = KEYMAP( \
  ...
  _______, M(M_UNDERGLOW_LAYER), _______,         KC_LALT, _______,          _______,                /**/  _______, _______,          KC_MPLY, KC_MSTP,  KC_MPRV, KC_MNXT \
),
...
[TENKEY_LAYER] = KEYMAP( \
  ...
  M_TO0,   _______, _______, KC_LALT, _______, _______, /**/ KC_NLCK, KC_KP_0, KC_KP_0, KC_PDOT, _______, _______ \
),
