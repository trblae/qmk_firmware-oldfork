...
[QWERTY_LAYER] = {
  ...
  {MEH_T(KC_CAPS), FUNC(7),  KC_LALT,  KC_LGUI,  FUNC(1),  FUNC(10),  FUNC(10),  FUNC(2),  KC_LEFT,  KC_DOWN,  KC_UP,  KC_RGHT}
},
...
[SPACEFN_LAYER] = {
  {LGUI(LSFT(KC_4)), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_UP,   KC_END,   KC_TRNS, KC_DELETE},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, RESET},
